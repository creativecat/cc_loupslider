...
if(typeof WB_URL == "undefined") var WB_URL = location.host;
if(typeof jQuery != "function"){

	head.js("http://ajax.googleapis.com/ajax/libs/jquery/1.5.1/jquery.min.js","http://" + WB_URL + "/modules/cc_loupslider/loupslider.js", function() {
		if (typeof jQuery().easing != "function") { head.js("http://" + WB_URL + "/modules/cc_loupslider/easing.js"); }
	...
	if (typeof jQuery().easing != "function") { head.js("http://" + WB_URL + "/modules/cc_loupslider/easing.js"); }
	head.js("http://" + WB_URL + "/modules/cc_loupslider/loupslider.js", function(){
		jQuery(document).ready(function(){
			start_cc_loupslider();
		});
	});
