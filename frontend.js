...
if(typeof jQuery != "function"){
	head.js("http://ajax.googleapis.com/ajax/libs/jquery/1.5.1/jquery.min.js","http://"+url+"/modules/cc_loupslider/loupslider.js", function() {
		if (typeof jQuery().easing != "function") { head.js("http://"+url+"/modules/cc_loupslider/easing.js"); }
	...
	if (typeof jQuery().easing != "function") { head.js("http://"+url+"/modules/cc_loupslider/easing.js"); }
	head.js("http://"+url+"/modules/cc_loupslider/loupslider.js", function(){
		jQuery(document).ready(function(){
			start_cc_loupslider();
		});
	});
